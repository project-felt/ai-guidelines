...
- **What they indicate**: These icons indicate to the user that when they click on them, the next action will use or be enabled by AI.
  - ![AI edit UI icon](../assets/images/rh-ui-icon-ai-edit.svg) `rh-ui-icon-ai-edit`: When clicked, the user will begin to edit something with help from AI.
  - ![AI troubleshoot UI icon](../assets/images/rh-ui-icon-ai-troubleshoot.svg) `rh-ui-icon-ai-troubleshoot`: When clicked, the user will receive help or suggestions from AI to troubleshoot.
  - ![AI filter UI icon](../assets/images/rh-ui-icon-ai-filter.svg) `rh-ui-icon-ai-filter`: When clicked, the user will filter data with help or suggestions from AI.
  - ![AI search UI icon](../assets/images/rh-ui-icon-ai-search.svg) `rh-ui-icon-ai-search`: When clicked, the user will begin to search with help from AI.
  - ![AI create UI icon](../assets/images/rh-ui-icon-ai-create.svg) `rh-ui-icon-ai-create`: When clicked, the user will create something new with help from AI.
  - ![AI enhance UI icon](../assets/images/rh-ui-icon-ai-enhance.svg) `rh-ui-icon-ai-enhance`: When clicked, the user will begin enhancing something with help from AI.
